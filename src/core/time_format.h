...
//--------------------------------------------------------------------------------
// FormatMinSec formats a duration as "Xm Ys" (seconds zero-padded to 2 digits),
// e.g. "5m 03s", and never switches to an hour form. FormatCountdown formats as
// "Xh Ym" once the duration reaches a full hour (3600s), otherwise falls back to
// FormatMinSec's "Xm Ys" form. Use this one for any "starts in ..." countdown
// that can span past 60 minutes.
//--------------------------------------------------------------------------------

...
std::vector<CyclicGroup> g_CyclicGroups =
{
    ...
    { "Eye of the North",
        ...
        {
            {"Twisted Marionette",      0, m20, ColorTier::Primary},
            {"Battle for Lions Arch", m30,m15,  ColorTier::Secondary},
            {"Dragonsorm",            m60, m20, ColorTier::Secondary},
            {"Tower of Nightmres",    m90,m15,  ColorTier::Secondary},
        }
    },
    ...
    { "Dry Top",
        ...
        {
            {"Crash Site", 0,    m40, ColorTier::Tertiary},
            {"Sandstorm",  m40, m20, ColorTier::Primary},
        }
    },
    ...
    { "The Desolation",
        ...
        {
            { "Junundu Rising",  m30, m20, ColorTier::Primary,   "[&BMEKAAA=]", 2 },
    ...
    { "Domain of Vabbi",
        ...
        {
            { "Forged with Fire", 0,    m30, ColorTier::Primary,   "[&BO0KAAA=]", 2 },

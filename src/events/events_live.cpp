...
{
    {"5869C555-53AF-4701-876B-02BFB5F0AD7A",
        33716.0f, 32109.0f,
        1052, "[&BBwIAAA=]",
        -747.0f, 369.0f, -223.0f, 100.0f},
    {"38F28682-B136-4B4D-9F87-E15379771C72",
        34980.0f, 34242.0f,
        1043, "[&BGwIAAA=]",
        412.0f, 241.0f, -196.0f, 100.0f},
    {"EAE3DF8F-244D-4BC3-9B7E-3B3A2BDAAFAB",
        36496.0f, 34112.0f,
        1045, "[&BAwIAAA=]",
        -302.0f, 108.0f, 507.0f, 100.0f},
    {"4A9E691A-BBFD-4C17-B2D6-D0B88D7C446F",
        35789.0f, 36581.0f,
        1041, "[&BFIIAAA=]",
        125.0f, 47.0f, 562.0f, 100.0f},
    {"32C14803-A210-4443-B8F4-F91641035B81",
        36060.0f, 37314.0f,
        1041, "[&BFMIAAA=]",
        290.0f, 105.0f, 115.0f, 100.0f},
    {"1ADCD34C-3281-4A52-9C4F-DBA62B75F94C",
        36582.0f, 37602.0f,
        1041, "[&BGUIAAA=]",
        608.0f, 44.0f, -59.0f, 100.0f},
    {"704DF521-84B3-46C1-9FE4-304AF55E6FB6",
        35389.0f, 30570.0f,
        1165, "[&BD8JAAA=]",
        -118.0f, 511.0f, 92.0f, 100.0f},
    {"D3109A18-8A51-4F79-94EB-B474024063F0",
        36469.0f, 41154.0f,
        1195, "[&BNUJAAA=]",
    ...
    {"BFA71CD0-ED1E-4EE3-B8A9-B23B98C3B786",
        45845.0f, 40318.0f,
        65, "[&BK0CAAA=]",
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// DisplayName   (see: events_live.h)
//--------------------------------------------------------------------------------
const char* DisplayName(const LiveEvent& ev)
{
    return Tr(("WE_NAME_LIVE_" + ev.eventId).c_str());
}
